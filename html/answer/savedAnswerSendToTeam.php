...
try {
  ...
  echo "<div class=\"textdiv\">The Answer is as follows:<br /><br /><div style=\"text-align: left\">$answerPreview</div></div>";
} catch (Exception $e) {
...
<script type="text/javascript">
		function update() {	
			$.ajax({
				cache: false,
				type: 'GET',
				url: 'answerSentTeam.php?id=<?php echo $_GET["id"]; ?>&pad=<?php echo $_GET["pad"]; ?>',
				timeout: 2000,
