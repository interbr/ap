...
$subject = "Question: ".strip_tags(utf8_decode($questionSubject))." -- Please answer quick or forward!";
...
'.$GLOBALS["aphost"].'/agentstatus/changeactive.php?email='.urlencode($agentaddress).'&pcode='.$pcodesend.'&status=0
If at any time you want to reactivate your account: 
'.$GLOBALS["aphost"].'/agentstatus/changeactive.php?email='.urlencode($agentaddress).'&pcode='.$pcodesend.'&status=1
If you want to change your settings (i.e. availability):
'.$GLOBALS["aphost"].'/agentstatus/settings.php?email='.urlencode($agentaddress).'&pcode='.$pcodesend.'&settings=1
